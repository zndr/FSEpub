...
class FSEApp(QMainWindow):
    ...
    def _build_patient_tab(self, parent: QWidget) -> None:
        ...
        self._btn_mw_start.setToolTip("Inserisci il codice fiscale e premi per aprire il FSE del paziente")
    ...
    def _show_about(self) -> None:
        ...
        QMessageBox.about(
            ...
            f"<i>Ideato da</i> "
            f"<b style='color: #2E86C1;'>dr. Dario Giorgio Zani</b> "
            f"<span style='font-size: 18px;'>&#x1FA7A;</span></p>"
            f"<hr>"
